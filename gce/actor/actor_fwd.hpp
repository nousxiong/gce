...
static match_t const msg_reg_acpr = atom("gce_reg_ac");
static match_t const msg_dereg_acpr = atom("gce_dereg_ac");
static match_t const msg_con_skt = atom("gce_con_skt");
static match_t const msg_decon_skt = atom("gce_decon_skt");
