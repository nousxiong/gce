...
struct attributes
{
  attributes()
    ...
    , nonblocked_num_(1)
    , actor_pool_reserve_size_(4)
    , socket_pool_reserve_size_(2)
    , acceptor_pool_reserve_size_(2)
    , actor_pool_max_size_(size_nil)
    , socket_pool_max_size_(size_nil)
    , acceptor_pool_max_size_(size_nil)
    , max_cache_match_size_(16)
    , max_tick_handle_size_(128)
    , tick_pool_reserve_size_(2)
    , tick_pool_max_size_(256)
    , msg_pool_reserve_size_(8)
    , msg_pool_max_size_(256)
    , mailbox_recv_pool_reserve_size_(2)
    , mailbox_recv_pool_grow_size_(8)
    , mailbox_mq_pool_reserve_size_(2)
    , mailbox_mq_pool_grow_size_(8)
    , mailbox_res_pool_reserve_size_(2)
    , mailbox_res_pool_grow_size_(8)
  ...
  size_t actor_pool_max_size_;
  size_t socket_pool_max_size_;
  size_t acceptor_pool_max_size_;
