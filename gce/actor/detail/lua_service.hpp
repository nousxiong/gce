  ...
  void make_libgce(std::string const& lua_gce_path)
  {
    ...
    gce::lualib::open(L)
      .begin("libgce")
        ...
        .end_userdata()
        .add_function("make_service_id", lua::service_id::make)
        ...
        .begin_userdata("actor")
          ...
          .add_function("link_svc", lua_actor_t::link_svc)
          .add_function("monitor", lua_actor_t::monitor)
          .add_function("monitor_svc", lua_actor_t::monitor_svc)
        ...
        .add_function("make_svcid", lua::make_svcid)
