...
local layout_gce_redis_adl_context_id = regist_layout_c(
  '\1\0\5\4\112\116\114\95\16\0\0\0',
  {fields.ptr_,},
  {});
layouts.gce_redis_adl_context_id = layout_gce_redis_adl_context_id

local mc = {};
mc = {
  adtype = function(o) return m.context_id end,
  skip_read = function(o,buf) return skip_read_c( field_list , mt_type_list , buf , layout_gce_redis_adl_context_id , o) end,
  size_of = function(o) return size_of_c( field_list , mt_type_list , layout_gce_redis_adl_context_id , o) end,
  read = function(o,buf) return read_c( field_list , mt_type_list , buf , layout_gce_redis_adl_context_id , o) end,
  write = function(o,buf) return write_c( field_list , mt_type_list , buf , layout_gce_redis_adl_context_id , o) end,
};
mc.__index = mc;
mt[1] = mc;
if ns.gce_redis_adl == nil then
  ...
  ns.gce_redis_adl.context_id = m.context_id
end
set_layout_mt_c( layout_gce_redis_adl_context_id , regist_mt_type(mt[1]) , 'ad_mt_gce_redis_adl.context_id' , mt[1]);
