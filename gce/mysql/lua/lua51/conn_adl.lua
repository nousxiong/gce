...
local layout_gce_mysql_adl_conn = regist_layout_c(
  '\1\0\5\4\112\116\114\95\16\0\0\0',
  {fields.ptr_,},
  {});
layouts.gce_mysql_adl_conn = layout_gce_mysql_adl_conn

local mc = {};
mc = {
  adtype = function(o) return m.conn end,
  skip_read = function(o,buf) return skip_read_c( field_list , mt_type_list , buf , layout_gce_mysql_adl_conn , o) end,
  size_of = function(o) return size_of_c( field_list , mt_type_list , layout_gce_mysql_adl_conn , o) end,
  read = function(o,buf) return read_c( field_list , mt_type_list , buf , layout_gce_mysql_adl_conn , o) end,
  write = function(o,buf) return write_c( field_list , mt_type_list , buf , layout_gce_mysql_adl_conn , o) end,
};
mc.__index = mc;
mt[1] = mc;
if ns.gce_mysql_adl == nil then
  ...
  ns.gce_mysql_adl.conn = m.conn
end
set_layout_mt_c( layout_gce_mysql_adl_conn , regist_mt_type(mt[1]) , 'ad_mt_gce_mysql_adl.conn' , mt[1]);
