...
namespace gce
{
class remote_common_relay_ut
{
public:
  static void run()
  {
    std::cout << "remote_common_relay_ut begin." << std::endl;
    ...
    std::cout << "remote_common_relay_ut end." << std::endl;
  }
  ...
  static void test_common()
  {
    try
    {
      ...
      for (std::size_t i=0; i<root_num; ++i)
      {
        thrs.create_thread(
          boost::bind(
            &remote_common_relay_ut::root, i, root_num,
