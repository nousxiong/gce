...
{
///----------------------------------------------------------------------------
coroutine_stackful_actor::coroutine_stackful_actor(aid_t aid, detail::cache_pool* user)
...
///----------------------------------------------------------------------------
void coroutine_stackful_actor::on_recv(detail::pack& pk, detail::send_hint)
{
  handle_recv(pk);
}
///----------------------------------------------------------------------------
